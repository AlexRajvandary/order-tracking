...
namespace OrderTracking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908154056_AddOrderItemCatalogSnapshot")]
    partial class AddOrderItemCatalogSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderTracking.Domain.Entities.AdminUser", b =>
                {
                    ...
                    b.Property<string>("TelegramAvatarUrl")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
            ...
            modelBuilder.Entity("OrderTracking.Domain.Entities.StatusDefinition", b =>
                {
                    ...
                    b.Property<int?>("PublishAfterDays")
                        .HasColumnType("integer");
