...
public sealed class ProductsController : ControllerBase
{
    ...
    public Task<Products.Application.Products.Models.ProductListResult> List(
        ...
        [FromQuery] string? laptopModel = null,
        [FromQuery] string? laptopProcessor = null,
        [FromQuery] string? laptopRamGb = null,
        [FromQuery] string? laptopStorageType = null,
        [FromQuery] string? laptopStorageGb = null,
        [FromQuery] string? laptopScreenSize = null,
        [FromQuery] string? laptopOperatingSystem = null,
        [FromQuery] string? tcgCharacter = null,
        [FromQuery] string? tcgSet = null,
        [FromQuery] string? tcgRarity = null,
        [FromQuery] string? tcgCrew = null,
        [FromQuery] string? yugiohCardType = null,
        [FromQuery] string? yugiohCardSubtype = null,
        [FromQuery] string? yugiohAttribute = null,
        [FromQuery] string? yugiohMonsterRace = null,
        [FromQuery] string? yugiohSeriesType = null,
