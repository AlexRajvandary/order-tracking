...
const FOOTER_COLUMNS: FooterColumn[] = [
  {
    ...
    links: [
      ...
      { href: "/catalog/auto-parts", label: "Запчасти" },
      { href: "/catalog/cosmetics", label: "Парфюмерия и косметика" },
      { href: "/catalog/music", label: "Музыкальные инструменты" },
      { href: "/catalog/computers", label: "Видеокарты и процессоры" },
