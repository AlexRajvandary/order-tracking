        ...
        <div className="min-w-0 bg-[#f1f3f4]">
          <div className="relative min-h-[500px] [&>div:first-child]:absolute [&>div:first-child]:inset-0 [&>div:first-child]:min-h-0 [&>div:nth-child(2)]:absolute [&>div:nth-child(2)]:inset-x-0 [&>div:nth-child(2)]:bottom-0 [&>div:nth-child(2)]:min-h-0 [&>div:nth-child(2)]:bg-[linear-gradient(180deg,rgba(248,250,251,0)_0%,rgba(248,250,251,0.45)_48%,rgba(238,241,243,0.82)_100%)] md:min-h-[500px] md:[&>div:nth-child(2)]:bg-none lg:min-h-[360px] lg:[&>div:nth-child(2)]:inset-y-0 lg:[&>div:nth-child(2)]:inset-x-auto lg:[&>div:nth-child(2)]:right-0 lg:[&>div:nth-child(2)]:w-[46%]">
            <div className="relative min-h-[250px] overflow-hidden bg-[#dfe7e9] lg:absolute lg:inset-0 lg:min-h-[360px]">
              {active.imageUrl ? <picture className="absolute inset-0 block"><source media="(min-width: 1024px)" srcSet={active.imageUrl === "/catalog-assets/mens-bottom.png" ? "/catalog-assets/mens-bottom-wide.png" : active.imageUrl === "/catalog-assets/mens-top.png" ? "/catalog-assets/mens-top-wide.png" : /bottom|\u043d\u0438\u0437/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-bottom-wide.png" : /top|\u0432\u0435\u0440\u0445/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-top-wide.png" : /dress|\u043f\u043b\u0430\u0442\u044c/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-dresses-wide.png" : active.imageUrl === "/catalog-assets/mens-kimono.png" ? "/catalog-assets/mens-kimono-wide.png" : active.imageUrl === "/catalog-assets/womens-kimono.png" ? "/catalog-assets/womens-kimono-wide.png" : active.imageUrl} /><source media="(min-width: 451px) and (max-width: 1023px)" srcSet={active.imageUrl === "/catalog-assets/mens-bottom.png" ? "/catalog-assets/mens-bottom-medium.png" : active.imageUrl === "/catalog-assets/mens-top.png" ? "/catalog-assets/mens-top-medium.png" : /bottom|\u043d\u0438\u0437/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-bottom-medium.png" : /top|\u0432\u0435\u0440\u0445/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-top-medium.png" : /dress|\u043f\u043b\u0430\u0442\u044c/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-dresses-medium.png" : active.imageUrl === "/catalog-assets/mens-kimono.png" ? "/catalog-assets/mens-kimono-medium.png" : active.imageUrl === "/catalog-assets/womens-kimono.png" ? "/catalog-assets/womens-kimono-medium.png" : active.imageUrl} /><source media="(max-width: 450px)" srcSet={active.imageUrl === "/catalog-assets/mens-bottom.png" ? "/catalog-assets/mens-bottom-mobile.png" : active.imageUrl === "/catalog-assets/mens-top.png" ? "/catalog-assets/mens-top-mobile.png" : /bottom|\u043d\u0438\u0437/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-bottom-mobile.png" : /top|\u0432\u0435\u0440\u0445/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-top-mobile.png" : /dress|\u043f\u043b\u0430\u0442\u044c/i.test(`${active.name} ${active.slug}`) ? "/catalog-assets/womens-dresses-mobile.png" : active.imageUrl === "/catalog-assets/mens-kimono.png" ? "/catalog-assets/mens-kimono-mobile.png" : active.imageUrl === "/catalog-assets/womens-kimono.png" ? "/catalog-assets/womens-kimono-mobile.png" : active.imageUrl} /><img key={active.id} src={active.imageUrl} alt="" className="absolute inset-0 h-full w-full object-cover transition-transform duration-500" /></picture> : <div className="absolute inset-0 bg-gradient-to-br from-[#dcecf1] to-[#f7fafb]" aria-hidden />}
            </div>
